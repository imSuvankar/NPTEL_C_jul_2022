...
*/
    ...
    if(n1 < n3) {
        if(n1 < n2) printf("%d is the smallest number.", n1);
        else printf("%d is the smallest number.", n2);
    }

    else if(n2 < n3) printf("%d is the smallest number.", n2);
    else printf("%d is the smallest number.", n3);
